...
const strings: Translations = {
  ...
  'settings.stopOnLimit': { en: 'Stop on Rate Limit', ko: '사용량 제한 시 중단' },
  'settings.stopOnLimitDesc': { en: 'Stop the sprint when all fallback models are rate-limited', ko: '모든 대체 모델이 사용량 제한에 걸리면 스프린트 중단' },
  ...
  'settings.wrappers': { en: 'CLI Wrappers', ko: 'CLI 래퍼' },
  'settings.wrappersDesc': { en: 'Use enhanced CLI wrappers instead of default backends', ko: '기본 백엔드 대신 향상된 CLI 래퍼 사용' },
  'settings.omcLabel': { en: 'omc (oh-my-claude-sisyphus)', ko: 'omc (oh-my-claude-sisyphus)' },
  'settings.omcDesc': { en: 'Use omc instead of claude CLI', ko: 'claude CLI 대신 omc 사용' },
  'settings.omxLabel': { en: 'omx (oh-my-codex)', ko: 'omx (oh-my-codex)' },
  'settings.omxDesc': { en: 'Use omx instead of codex CLI', ko: 'codex CLI 대신 omx 사용' },
  'settings.wrapperNotInstalled': { en: 'Not installed', ko: '미설치' },
